    ...
    <div className='my-10'>
      ...
      {showOptions && <div>
        <input type='time' onChange={(e) => props.setTime(e.target.value)}
          className='block w-1/2 md:w-1/4 m-auto px-4 py-3 gap-x-3'
        ...
        />
        <div className='flex m-auto w-1/2 md:w-1/4 justify-center bg-white rounded-b-2xl items-center'>
          <select className='p-2 rounded-full w-[80%] md:w-[70%] text-center' onChange={(e) => props.setCategory(e.target.value)}>
